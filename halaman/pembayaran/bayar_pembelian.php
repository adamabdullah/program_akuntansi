...
if(isset($_POST['kode'])){  
    ...
    $sql_make_kode = "SELECT max(ExtractNumber(kode_transaksi)) AS no_transaksi FROM transaksi_akun WHERE kode_transaksi like'%Purchase%'";
    ...
    if($data_make_kode['no_transaksi']>0){
        ...
        $nomor++;
        $kode_baru = "Purchase Payment # ".$nomor;

    }else{
        $kode_baru = "Purchase Payment # 10000";
    }
  }else{
				...
				<div class="row content">			
					<div class="col-sm-12 col-md-12 col-lg-6" style="text-align:left">
							...
							<h2><small>Transaksi</small><br>
								<p class="text-primary" id="context-span">Pengiriman Pembayaran</p>
							</h2>
