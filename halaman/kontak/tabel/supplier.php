...
while($data_sum = mysqli_fetch_array($hasil_sum))
{
	$output .="<tr>
					...
					<td>
						<a href='' data-sisa=".$data_sum['sisa']." data-telpon=".$data_sum['phone']."  data-alamat=".$data_sum['alamat_penagihan']." data-email=".$data_sum['email']." data-nama=".$data_sum['nama']." data-tipe=".$data_sum['tipe_kontak']." class='btn btn-success btn-rounded btn-sm edit'".$_SESSION['write']."><span class='fa fa-edit'></span></a>
