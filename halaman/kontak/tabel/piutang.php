...
$sql = "SELECT kontak.alamat_penagihan, kontak.tipe_kontak, kontak.email, kontak.phone, kontak.nama as nama, ifnull(sum(transaksi_produk.sisa_tagihan),0) as sisa, transaksi_produk.kolom from kontak inner join transaksi_produk on kontak.nama = transaksi_produk.pelanggan group by kode having kolom='penjualan';";
