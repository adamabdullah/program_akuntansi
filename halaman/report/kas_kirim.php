...
if(!empty($_POST)){ 
    ...
    $sql_penerima = "SELECT * FROM transaksi WHERE kode_transaksi = '$kode' AND debit > 0 AND kolom != 'kirim_uang_pajak'";
    
    $sql_person = "SELECT  DISTINCT kontak, tgl_transaksi, kode_transaksi FROM transaksi_akun WHERE kode_transaksi = '$kode'";
            ...
            <div class="box">
                ...
                <div class="box-body" style="border-top:2px gray solid;">
                    ...
                    <div class="container-fluid bg-info" style="height:100px;">
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-3">
                            <h4>
                                <p class="text-primary bayar_dari"><?php echo $data_pengirim['kode_akun'];?></p>
                    ...
                    <div class="container-fluid" style="margin-top:20px">
                        <table class="table table-responsive">
                            ...
                            <?php while($data_penerima = mysqli_fetch_array($res_penerima)){ ?>
                                <tr>
                                    <td class="harga_pajak" hidden><?php echo $data_penerima['harga_pajak']; ?></td>
                                    <div class="nama_pajak_ori" hidden><?php echo $data_penerima['nama_pajak_ori'] ?></div>
                                    <td class="kode_akun"><?php echo $data_penerima['kode_akun']; ?></td>
                                    <td><?php echo $data_penerima['kolom']; ?></td>
                                    <td style="text-align:right" class="harga_akun"><?php echo $data_penerima['debit']; ?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
...
$(document).ready(function(){
    ...
    $("#to_pdf").click(function(){
        ...
        var form = document.createElement("form");
            ...
            form.setAttribute("action", "pdf/kas_kirim.php");
            ...
            window.open('pdf/kas_kirim.php', 'formresult', 'scrollbars=no,menubar=no,height=600,width=800,resizable=yes,toolbar=no,status=no');
    ...
    $("#edit").click(function()
    {
        ...
        var url = '/faktur_v2/halaman/edit/kirim_uang2.php';
        ...
        // var form = document.createElement("form");
        //     form.setAttribute("method", "post");
        //     form.setAttribute("action", "/faktur_v2/halaman/edit/kirim_uang.php");
