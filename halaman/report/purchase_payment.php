                            ...
                            <div class="col-md-1 col-md-offset-3">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                        <li><a href="#" id="purchase_paymentPDF">PDF</a></li>
                                    </ul>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    $("#delete").click(function(){
	 ...
	 $("#edit").click(function(){
        ...
        var form = document.createElement("form");
            ...
            form.setAttribute("action", "/faktur_v2/halaman/edit/purchase_payment.php");
    ...
    $("#purchase_paymentPDF").click(function(){
        var form = document.createElement("form");
            form.setAttribute("method", "post");
            form.setAttribute("action", "pdf/purchase_payment.php");
            ...
            window.open('pdf/purchase_payment.php', 'formresult', 'scrollbars=no,menubar=no,height=600,width=800,resizable=yes,toolbar=no,status=no');
