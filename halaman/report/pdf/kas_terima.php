...
if(!empty($_POST)){
    ...
    $kode = $_POST['kode'];
    $sql_penerima = "SELECT kode_akun,debit FROM transaksi WHERE kode_transaksi = '$kode' AND debit > 0";

    $sql_person = "SELECT * FROM transaksi_akun WHERE kode_transaksi = '$kode'";

    $sql_pengirim = "SELECT * FROM transaksi WHERE kode_transaksi = '$kode' AND debit = 0";
            ...
            <div class="box">
                ...
                <div class="box-body" style="border-top:2px gray solid;">
                    ...
                    <div class="container-fluid bg-info" style="height:100px;">
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-3">
                            <h4>
                                <p class="text-primary"><?php echo $data_terima['kode_akun'];?></p>
                    ...
                    <div class="container-fluid" style="margin-top:20px">
                        <table class="table table-responsive">
                            ...
                            <?php while($data_pengirim = mysqli_fetch_array($res_pengirim)){ ?>
                                <tr>
                                    <td><?php echo $data_pengirim['kode_akun']; ?></td>
                                    <td><?php echo $data_pengirim['kolom']; ?></td>
                                    <td><?php echo $data_pengirim['harga_pajak']; ?></td>
                                    <td style="text-align:right"><?php echo $data_pengirim['kredit']; ?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
