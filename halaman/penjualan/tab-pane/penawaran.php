...
<div style="margin-top:55px; ">       
    <table id="table_penawaran" class="display" style="width:100%">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM penjualan where jenis_transaksi='penawaran'";
...
$(document).ready(function () 
{
   ...
   'language': {
      'emptyTable': '<br> Data Kosong <br> <br><button type="button" id="new_transaksi" class="btn btn-primary"><img class="img_icon" width="35px" height="25px" src="../../dist/img/icon/sales.svg">Buat Penawaran Baru</button>'
   }
});
