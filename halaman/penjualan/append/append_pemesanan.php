...
<tr>
	...
	<td>
		<div class="form-group"><input class="form-control quantity" id="jumlah" placeholder="jumlah" style="width: 7em" min=0 id="">
		<div></div>
								<span class="text-danger">
	...
	<td>
		<div class="form-group">
			<input class="form-control jumlah_uang_produk" id="uang" placeholder="uang" data-uang=""></div>
			<span class="text-danger">
