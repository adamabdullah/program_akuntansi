...
$sql_select_pembelian = "SELECT 
                        tgl_transaksi, kode, pelanggan, 
                        tgl_tempo, sisa_tagihan, 
                        total 
                        FROM transaksi_produk WHERE kolom = '$kolom' AND tgl_tempo < CURDATE() ORDER BY kode ASC";
                            ...
                            <table class="table table-responsive" style="margin-top:25px">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th><p>Tanggal</p></th>
                                        <th><p>Nomor</p></th>
                                        <th><p><?php echo $identifikasi ?></p></th>
