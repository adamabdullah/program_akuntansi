...
$sql_select_pembelian = "SELECT * FROM transaksi_produk WHERE kolom='penjualan' AND tgl_tempo <= DATE_ADD(CURDATE(), INTERVAL 30 DAY) AND CURDATE() <=tgl_tempo";
