...
$query = "SELECT max(ExtractNumber(kode)) as no_transaksi from transaksi_produk where kolom='pembelian'";
...
if(isset($data['no_transaksi'])) 
{
	...
	$kodeBarang = $noUrut;
	?>
		<div id="keterangan" style="display: none;">Purchase Invoice # <?php echo $kodeBarang; ?></div>
	<?php
}
else
{
	$kodeBarang = "Purchase Invoice # 10000";
	?>
        ...
        <section>
						...
						<div class="box-body bg-info">
							<div class="form-group row">
								<div class="col-xs-10 col-sm-4 col-md-3">
									<strong class="text-black">* Supplier</strong>
									 <select id="kontak" class="form-control">
								    	<option id="kontak_baru"><i class="fa fa-plus"></i>&nbsp;Ketuk untuk menambahkan kontak
								    	</option>	
										 <?php
							...
							<!-- <div class="col-md-12 col-lg-3 col-xs-12 col-sm-12">
								<div class="form-group">
									...
									<div class="input-group-addon">
										...
										<input type="text" id="tag" class="form-control" name="" id="">
									</div>
								</div>
								<div class="form-group" id="penawaran-only">
									<label>Gudang</label>
									<div class="input-group select">
									<div class="input-group-addon">
										<i class="fa fa-calendar"></i>
					...
					<div class="container-fluid">
						<div class="box">						
							...
							<table class="table table-hover" id="tabel_pemesanan_penjualan">
								...
								<td><div class="form-group"><input class="form-control quantity" id="jumlah" placeholder="jumlah" style="width: 7em" min=0 id=""><span class="text-danger">
								...
								<td><div class="form-group"><input class="form-control harga_satuan" id="satuan" placeholder="satuan">
									<span class="text-danger">
			...
			<select id="pajak_awal" class="form-control pajak_append_select" data-pajak="" data-uang_pajak="">
				...
				?> 
								...
								<td><div class="from-group"><input class="form-control jumlah_uang_produk" id="uang" placeholder="uang"  data-uang="998"><span class="text-danger">
	...
	$(document).ready(function()
	{
				...
				success:function(data)
					{
						...
						{
							var t = parseInt(data.harga_satuan);
							var b = t.toLocaleString();
							// var c = b.split(",").join(".");
							$("#tabel_pemesanan_penjualan tbody tr:eq("+baris+") td").find("input.harga_satuan").val(b);
							$("#tabel_pemesanan_penjualan tbody tr:eq("+baris+") td").find("input.jumlah_uang_produk").val(b);
		...
		$(document).on('click', '#tambah_produk_new_append, #tambah_baru_append_akun, #tambah_produk',function() //menambahkan produk baru tanpa ketik
	 	{
		 	...
		 	$("#beli_produk").prop('disabled',true);
	 	});
	 	...
	 	$(document).on('click', '.kurangi',function(e)
		{
			...
			$(".jumlah_uang_produk").each(function()
			{
	 		...
	 		$.ajax({
				url:"/faktur_v2/halaman/pembelian/update/delete-query/index.php",
				method:"POST",
		...
		$("#tambah_penerimaan2").click(function()
	 	{
	 		$.ajax({
				url:"/faktur_v2/halaman/pembelian/append_update/index.php",
				method:"POST",
				data:{},
				success:function(data) 
				{
	 ...
	 $("#simpan-kontak").click(function(e)
    {
	 	...
	 	$("#simpan-produk-modal").click(function()
	 	{
	        ...
	        ({
	            ...
	            success  : function(data)
	            {
	            	...
	            	// $("#tabel_pemesanan_penjualan tbody tr:eq("+a+") td .produk_append").siblings(".es-list").append("<li value='"+kode_produk+" | "+nama_produk+"' id='pajak_append_isi' class='produk_isi es-visible'>"+kode_produk+" | "+nama_produk+"</li>");
		...
		if(panjang >= 1)
		{
			$.each(nama_produk,function(index,obj)
			{
				...
				var $t = $(this);
				var stlh_satuan1 = o*qty_produk[index];
				var stlh_satuan = stlh_satuan1.toLocaleString();
				if(index == 0)
				{
					...
					$("#tabel_pemesanan_penjualan tbody tr:eq("+index+") td div").find("input.jumlah_uang_produk").val(stlh_satuan+".00");
				...
				{	 
					$.ajax({
						url:"/faktur_v2/halaman/pembelian/append_lawas/index.php",
						method:"POST",
						data:{},
						success:function(data) 
						{
							...
							$("#tabel_pemesanan_penjualan tbody tr:eq(1) td div").find("input.jumlah_uang_produk").val(stlh_satuan+".00");
	 	...
	 	$("#buat_penjualan").click(function(e)
	 	{
			...
			$(".jumlah_uang_produk").each(function()
			{
	 		...
	 		$.ajax
	        ({
	            url      : "/faktur_v2/halaman/pembelian/update/update-query.php",
	            type     : "POST",
	            dataType : 'json',
