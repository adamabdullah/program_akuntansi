        ...
        <section>
				<div class="row content">
					...
					<div class="col-sm-12 col-md-12 col-lg-6" style="text-align:left">
							...
							<h2><small>Transaksi</small><br>
								<p class="text-primary" id="context-span">Pembelian Baru</p>
							</h2>
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-3 col-xs-12 col-sm-12">
								...
								<div class="form-group">
									...
									<input type="date" value="<?php echo date('Y-m-d')?>" class="form-control" id="tgl_tempo">
									</div>
									<!-- /.input group -->
								</div>
							<!-- /.form-group -->
							...
							<div class="col-md-12 col-lg-3 col-xs-12 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="" id="nomor_transaksi" readonly="true">
								</div>
					...
					<div class="container-fluid">
						<div class="box">						
							...
							<table class="table table-hover" id="tabel_pemesanan_penjualan">
								...
								<div class="col-md-12"> 
									<select id="produk_append" class="form-control produk_append" required>
			...
			<select id="pajak_awal" class="form-control pajak_append_select" data-pajak="" data-uang_pajak="">
				...
				?> 
								...
								<td><div class="from-group"><input class="form-control jumlah_uang_produk" id="uang" placeholder="uang"  data-uang="998"></div>
								<span class="text-danger">
				...
				<div class="row">
					<div class="container-fluid">
						...
						<div class="col-lg-6 col-sm-6 col-md-6 pull-right">
							...
							<button type="button" class="btn btn-primary" id="buat_pembelian">
								<i class="fa fa-plus"></i> Buat Pembelian
							</button>
							</div>
	...
	$(document).ready(function()
	{
		...
		var a = parseInt(0);
	 	...
	 	function check_produk(query, baris)
	 	{
	 		...
	 		$.ajax({
				url:"/faktur_v2/halaman/pembelian/proses-pembelian/check_produk.php",
				method:"POST",
...
$(document).on('click', '.kurangi',function(e) //------------------------------untuk mengecek (akun)
{
	...
	// 	});
	 	...
	 	$("#buat_pembelian").click(function()
	 	{
			...
			$("textarea.deskripsi").each(function(index) 
			{
				var a = $(this).val();
				if(a == '' )
				{
			...
			$(".jumlah_uang_produk").each(function()
			{
				...
				else
				{
					...
					$.ajax
					({
						url      : "/faktur_v2/halaman/pembelian/proses-pembelian/save_pembelian.php",
						method     : "POST",
						dataType :'json',
